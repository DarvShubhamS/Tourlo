...
var displayMaps = function displayMaps(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2h1YmhhbXNheGVuYSIsImEiOiJja2FsMGFjcjAwbHN0MnlvNjU2eHI3NXdzIn0.q6tiDzR1HuNk3fOq3wktSA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/shubhamsaxena/ckal0vktk0q1b1ill2rffsc0u',
    scrollZoom: false // center: [-115.172652,
    //     36.110904],
    // zoom: 4
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ":").concat(loc.description, " </p>")).addTo(map); //extend map bound include current location
...
var SignUp = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, password, confirmpass) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Signed Up In Successfully');
              window.setTimeout(function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:3000/api/v1/users/updatepass' : 'http://localhost:3000/api/v1/users/updateUser';
            _context.next = 4;
            return (0, _axios.default)({
              method: "PATCH",
              url: url,
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"forgetPass.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.ForgetPass = void 0;
...
var ForgetPass = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Reset Email Sent Successfully');
            }
...
var stripe = Stripe('pk_test_BsZN5uIBY3z1NthCHiDIWMGs00YvA7j6wa');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //use stripe to create checkout form + process payment
...
var _forgetPass = require("./forgetPass");
...
var buyButton = document.getElementById('book-Tour'); //values

var logoutbttn = document.querySelector('.nav__el--logout');
...
if (SignUpForm) {
  SignUpForm.addEventListener('submit', function (e) {
    ...
    (0, _Signup.SignUp)(name, email, password, confirmpass);
  });
}
...
if (PassForm) {
  PassForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var currentPass, password, confirmpass;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
...
if (resetPass) {
  resetPass.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = document.getElementById('email').value;
    (0, _forgetPass.ForgetPass)(email);
  });
}
